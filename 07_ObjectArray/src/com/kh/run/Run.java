...
public class Run {
	...
	public static void main(String[] args) {
		...
		stdArr[0] = new Student("김민성",26,100.0); // | Student객체 | null | null |
		stdArr[1] = new Student("임수진",20,88.5);  // | Student객체 | Student객체 | null |
		...
		//*출력
		for(Student n:sArr) { // for(int i=0; i<sArr.length;i++)
			n.printInfo();   //=>sArr[i].printInfo();
		}
