...
public class Run {
	...
	public static void main(String[] args) {
		...
		// => 실제 각 필드에 담긴 데이터들이 일치하면 10진수 형태로 반환
		// Student 에 equals() 오버라이딩
		// => 실제 각 필드에 담긴 데이터를 가지고 비교. 모두 일치하면 true, 그렇지 않으면 false 리턴
		...
		//	* ArrayList에 저장하는 방법 1) ArrayList 생성 후 addAll 메소드 사용
		ArrayList<Student> list = new ArrayList<>();
		list.addAll(hs2);
		
		//	*ArrayList 에 저장하는 방법 2) ArrayList를 생성과 동시에 전달
