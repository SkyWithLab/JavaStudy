...
public class API2_String {
	...
	public static void main(String[] args) {
		...
		//test1(); => static 메모리에 올라와있을 때만 사용 가능(public static void test1())
		//API2_String api2 = new API2_String();
		//api2.test1();
		test2();
	...
	public static void test2() {
		...
		//					문자열에서 시작인덱스부터 마지막위치까지 문자열을 추출하여 리턴
		...
		//				   해당 문자열을 구분자를 기준으로 분리하여 문자열 배열 형태로 반환
		System.out.println("=========================");
