...
public class A_UnCheckedException {
	 ...
	 * 		그렇기 떄문에 if 문 등 조건 처리를 통해 애초에 예외가 발생하지 않도록 방지 가능!
	 */
	// --- 필드부 -----------
	...
	public void test1() {
		...
		// result = n1 / n2;
		// => 두번쨰 입력 값(n2)이 0인 경우 예외 발생. -> 프로그램이 비정상적으로 종료됨!
		...
		try {
			...
			//e.printStackTrace(); // 예외 정보, 발생 지점을 확인할 수 있는 메소드
		}
	...
	public void test3() {
		...
		//		이때, 순서에 유의해야 함! (부모타입보다 자식타입이 위쪽에 작성되어야 한다)
